...
var coordinate_system = function(scene){
    ...
    this.draw = function(){
        ...
        // axes
        this.axes.x = this.drawLine(this.vec(this.min, this.min, this.max), this.vec(this.max, this.min, this.max), this.axisMaterial);
        this.axes.y = this.drawLine(this.vec(this.min, this.min, this.max), this.vec(this.min, this.max, this.max), this.axisMaterial);
        this.axes.z = this.drawLine(this.vec(this.min, this.min, this.min), this.vec(this.min, this.min, this.max), this.axisMaterial);

        // arrow heads
        this.arrowheads.x = this.drawCone(this.vec(this.max, this.min, this.max), 10, 20, this.axisMaterial, "X");
        this.arrowheads.y = this.drawCone(this.vec(this.min, this.max, this.max), 10, 20, this.axisMaterial, "Y");
        this.arrowheads.z = this.drawCone(this.vec(this.min, this.min, this.min), 5, 10, this.axisMaterial, "Z");
    }
